...
todoForm.addEventListener("submit", function (e) {
  ...
  newRow.className =
    "bg-white border-b border-[#E3E7D3] text-[#1A1A1A] hover:bg-[#F1F3E0] transition-colors";
...
function changeStatus(element) {
  if (element.innerText === "PENDING") {
    ...
    element.className =
      "status-badge cursor-pointer bg-blue-100 text-blue-700 px-2 py-1 rounded-full font-bold italic";
  } else if (element.innerText === "ON PROGRESS") {
    element.innerText = "DONE";
    element.className =
      "status-badge cursor-pointer bg-green-100 text-green-700 px-2 py-1 rounded-full font-bold italic line-through";
    element
      .closest("tr")
      .cells[0].classList.add("line-through", "text-gray-400");
  } else {
    element.innerText = "PENDING";
    element.className =
      "status-badge cursor-pointer bg-yellow-100 text-yellow-700 px-2 py-1 rounded-full font-bold italic";
    element
      .closest("tr")
      .cells[0].classList.remove("line-through", "text-gray-400");
  }
}
